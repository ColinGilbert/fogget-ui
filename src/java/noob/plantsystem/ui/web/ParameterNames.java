...
public class ParameterNames {
    ...
    static public final String updateMistingInterval = "updateMistingInterval";

    static public final String updateMistingDuration = "updateMistingDuration";

    static public final String updateStatusPushInterval = "updateStatusPushInterval";
    ...
    static public final String updateTargetUpperChamberTemperature = "updateTargetUpperChamberTemperature";
